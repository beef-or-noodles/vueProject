<template>
  <div>
	...
	<!-- Hero section start -->
	<section class="hero-section set-bg" id="home">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
					<figure>
						<img src="../../../static/view/img/author.jpg" alt="">
					</figure>
				</div>
	...
	<section class="portfolio-section spad" id="works">
		<div class="container">
			...
			<div class="row isotope_items">
				...
				<!-- item -->
				<div class="col-md-6">
					<a class="work-item work-image" href="../../../static/view/img/works/4.jpg">
	...
	<footer class="footer-section spad set-bg">
		<div class="container">
